...
package zlk.com.rxbuslearn.scan.androidzxing;
...
import zlk.com.rxbuslearn.scan.androidzxing.camera.CameraManager;
import zlk.com.rxbuslearn.scan.androidzxing.common.Scanner;
import zlk.com.rxbuslearn.scan.androidzxing.decode.DecodeThread;
...
final class ScannerViewHandler extends Handler {
    ...
    ScannerViewHandler(ScannerOptions scannerOptions, CameraManager cameraManager, HandleDecodeListener handleDecodeListener) {
        ...
        //启动扫描线程
        decodeThread = new DecodeThread(cameraManager, this, scannerOptions.getDecodeFormats(), scannerOptions.isCreateQrThumbnail());
